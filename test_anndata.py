...
ref_adata.uns['cell_type'] = ref_label.to_numpy().reshape(-1)
...
query_adata.uns['cell_type'] = query_label.to_numpy().reshape(-1)
...
auxilary_adata.uns['label'] = auxilary_label.to_numpy()

ref_adata.write('ref_data.h5ad')
query_adata.write('query_data.h5ad')
auxilary_adata.write('auxilary_data.h5ad')
