...
for i in ${projects[@]}; do
    # ref_query_auxilary
    CUDA_VISIBLE_DEVICES=2 python gt_main.py --data_dir=./experiments/$i  --use_auxilary
    CUDA_VISIBLE_DEVICES=2 python gt_main.py --add_pos_enc --data_dir=./experiments/$i --use_auxilary
    CUDA_VISIBLE_DEVICES=2 python gt_main.py --active_learning --data_dir=./experiments/$i --use_auxilary
    CUDA_VISIBLE_DEVICES=2 python gt_main.py --adj_training --data_dir=./experiments/$i --use_auxilary
    CUDA_VISIBLE_DEVICES=2 python gt_main.py --adj_training --add_pos_enc --active_learning --data_dir=./experiments/$i --use_auxilary
    
    # ref_query
    # CUDA_VISIBLE_DEVICES=2 python gt_main.py --data_dir=./experiments/$i
    # CUDA_VISIBLE_DEVICES=2 python gt_main.py --add_pos_enc --data_dir=./experiments/$i
    # CUDA_VISIBLE_DEVICES=2 python gt_main.py --active_learning --data_dir=./experiments/$i
    # CUDA_VISIBLE_DEVICES=2 python gt_main.py --adj_training --data_dir=./experiments/$i
    # CUDA_VISIBLE_DEVICES=2 python gt_main.py --adj_training --add_pos_enc --active_learning --data_dir=./experiments/$i       
done