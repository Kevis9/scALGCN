...
for i in ${projects[@]}; do
    ...
    # CUDA_VISIBLE_DEVICES=0 python gt_main.py --active_learning --add_pos_enc --data_dir=./experiments/$i --use_auxilary
    ...
    # CUDA_VISIBLE_DEVICES=0 python gt_main.py --add_pos_enc --data_dir=./experiments/$i
    ...
    # CUDA_VISIBLE_DEVICES=0 python gt_main.py --adj_training --add_pos_enc --active_learning --data_dir=./experiments/$i       
done