...
for i in $projects; do
    ...
    # ref_query
    python gt_main.py --data_dir=./experiments/$i --use_auxilary=False
    python gt_main.py --add_pos_enc --data_dir=./experiments/$i --use_auxilary=False
    python gt_main.py --active_learning --data_dir=./experiments/$i --use_auxilary=False
    python gt_main.py --adj_training --data_dir=./experiments/$i --use_auxilary=False
    python gt_main.py --adj_training --add_pos_enc --active_learning --data_dir=./experiments/$i --use_auxilary=False
    ...
    # query_ref
    python gt_main.py --data_dir=./experiments/$i --exp_reverse --use_auxilary=False
    python gt_main.py --add_pos_enc --data_dir=./experiments/$i --exp_reverse --use_auxilary=False
    python gt_main.py --active_learning --data_dir=./experiments/$i --exp_reverse --use_auxilary=False
    python gt_main.py --adj_training --data_dir=./experiments/$i --exp_reverse --use_auxilary=False
    python gt_main.py --adj_training --add_pos_enc --active_learning --data_dir=./experiments/$i --exp_reverse --use_auxilary=False
