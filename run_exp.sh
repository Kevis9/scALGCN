...
for i in ${projects[@]}; do
    # ref_query_auxilary
    # CUDA_VISIBLE_DEVICES=3 python gt_main.py --adj_training --active_learning --data_dir=./experiments/$i --use_auxilary    
    CUDA_VISIBLE_DEVICES=3 python gt_main.py --adj_training --data_dir=./experiments/$i --use_auxilary
    # CUDA_VISIBLE_DEVICES=3 python gt_main.py --active_learning --data_dir=./experiments/$i --use_auxilary
    # CUDA_VISIBLE_DEVICES=3 python gt_main.py --data_dir=./experiments/$i --use_auxilary
        
done

for i in ${projects2[@]}; do
    ref_query
    # CUDA_VISIBLE_DEVICES=3 python gt_main.py --adj_training --active_learning --data_dir=./experiments/$i
    CUDA_VISIBLE_DEVICES=3 python gt_main.py --adj_training --data_dir=./experiments/$i
    # CUDA_VISIBLE_DEVICES=3 python gt_main.py --active_learning --data_dir=./experiments/$i
    # CUDA_VISIBLE_DEVICES=3 python gt_main.py --data_dir=./experiments/$i
done
